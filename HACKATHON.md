# Acodemic X G.I.R.L.S. Global SDG Hackathon

**Event page:** https://acodemic-hackathon.devpost.com/  ·  **Rules:** https://acodemic-hackathon.devpost.com/rules
**Deadline:** **Sun Sep 27, 2026 · 12:45 AM EDT**  (`2026-09-27T00:45:00-04:00`)
> Devpost lists it as Sep 26, 2026 @ 11:45pm CDT, i.e. the night of Saturday Sep 26.
...
## Theme
Digital solutions to the UN Sustainable Development Goals, emphasising real-world impact and creativity.
...
- Publicly accessible project link
- Project description explaining SDG alignment
- At least 3 screenshots
- Demo video, 1–5 min (optional; make it anyway)
...
- At least 3 captioned screenshots in `submission/gallery/`
- `submission/video/demo.mp4`: 1:30–3:00

## Strategy notes (starting hypotheses, which the research may overturn)
- Weights are unpublished, so treat the three criteria as equal.
- Pick an SDG other than 3 (health; UnivaBio and DSH cover it) or 4 (education; CSC covers it).
- The strongest entries use a real open dataset (UN SDG API, World Bank, Our World in Data, NASA, FAO, OpenStreetMap) and end in an actionable output for a specific person.

**Suggested lane:** SDG 2 / 6 / 7 / 11 / 12 / 13 / 14 / 15 (not 3 or 4).
...
| [`acodemic-hackathon`](https://github.com/rishikrrontala-bot/acodemic-hackathon) | Acodemic × G.I.R.L.S. SDG **← this repo** | Sun Sep 27, 2026 · 12:45 AM EDT | SDG 2 / 6 / 7 / 11 / 12 / 13 / 14 / 15 (not 3 or 4). |
